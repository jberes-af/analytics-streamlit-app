...
from src.application.services.activity.generate_insights_service import (
...
class AnalysisAppContainer:
    ...
    scatter_line_chart_daily_renderer: PlotlyScatterLineChartRenderer
...
def build_analysis_app_container(
    ...
    generate_insights_uc: GenerateInsightsInteractor = (
        _build_insights_use_case(
        ))
    ...
    run_all_use_cases: RunAnalyticsUseCasesInteractor = RunAnalyticsUseCasesInteractor(
        ...
        generate_insights_use_case=generate_insights_uc,
    )
    ...
    return AnalysisAppContainer(
        ...
        insights_presenter_service=insights_presenter_service,
...
def _build_controller(
    ...
    return RunAnalyticsUseCasesController(
...
def _build_insights_use_case() -> GenerateInsightsInteractor:
